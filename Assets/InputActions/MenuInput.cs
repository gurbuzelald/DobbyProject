...
public partial class @MenuInput: IInputActionCollection2, IDisposable
{
    ...
    ""controlSchemes"": []
        ...
        m_PickCharacterSceneButtons_A = m_PickCharacterSceneButtons.FindAction("Dobby", throwIfNotFound: true);
        m_PickCharacterSceneButtons_D = m_PickCharacterSceneButtons.FindAction("Joleen", throwIfNotFound: true);
        m_PickCharacterSceneButtons_B = m_PickCharacterSceneButtons.FindAction("Glassy", throwIfNotFound: true);
        m_PickCharacterSceneButtons_E = m_PickCharacterSceneButtons.FindAction("Lusth", throwIfNotFound: true);
        m_PickCharacterSceneButtons_C = m_PickCharacterSceneButtons.FindAction("Guard", throwIfNotFound: true);
        m_PickCharacterSceneButtons_G = m_PickCharacterSceneButtons.FindAction("Michelle", throwIfNotFound: true);
        m_PickCharacterSceneButtons_F = m_PickCharacterSceneButtons.FindAction("Eve", throwIfNotFound: true);
        m_PickCharacterSceneButtons_J = m_PickCharacterSceneButtons.FindAction("Aj", throwIfNotFound: true);
        m_PickCharacterSceneButtons_I = m_PickCharacterSceneButtons.FindAction("Boss", throwIfNotFound: true);
        m_PickCharacterSceneButtons_L = m_PickCharacterSceneButtons.FindAction("Ty", throwIfNotFound: true);
        m_PickCharacterSceneButtons_K = m_PickCharacterSceneButtons.FindAction("Mremireh", throwIfNotFound: true);
    ...
    private readonly InputAction m_PickCharacterSceneButtons_L;
    ...
    public struct PickCharacterSceneButtonsActions
    {
        ...
        public InputAction @L => m_Wrapper.m_PickCharacterSceneButtons_L;
